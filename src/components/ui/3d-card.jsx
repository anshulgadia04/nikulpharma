...
// Hook to get rotation values for counter-rotation
export const useCardRotation = () => {
  const context = useContext(MouseEnterContext);
  if (context === undefined) {
    throw new Error("useCardRotation must be used within a MouseEnterProvider");
  }
  return context[2]; // rotation object
};
